...
// 
// Uses a non-uniform mesh.
//
// Usage:
//     ./TestPeriodicBC_sin_nonuniform <dim> --info 5

#include "Ippl.h"

#include "Meshes/Centering.h"
#include "PoissonSolvers/FEMPoissonSolver_nonuniform.h"
...
void testFEMSolver(const unsigned& numNodesPerDim, const T& domain_start = 0.0,
    ...
    ippl::FEMPoissonSolver_nonuniform<Field_t, Field_t> solver(lhs, rhs);
