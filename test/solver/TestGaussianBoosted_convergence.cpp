...
void compute_convergence(std::string algorithm, int pt) {
    ...
    ippl::Index I(pt);
    ippl::Index I_boosted(factor * pt);
    ippl::NDIndex<3> owned(I, I, I_boosted);
    ...
    errorMsg << std::setprecision(16) << dx << " " << dz << " " << err << " " 
...
int main(int argc, char* argv[]) {
    ippl::initialize(argc, argv);
    {
        ...
        msg << "Spacing SpacingZ Error ErrorEx ErrorEy ErrorEz" << endl;
