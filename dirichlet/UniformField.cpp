// Particle in a Uniform Field Test
//   Usage:
//     srun ./UniformField
...
//     Example:
//     srun ./UniformField 128 128 128 10000 10 FFT 0.01 LeapFrog --overallocate 2.0 --info 10

constexpr unsigned Dim = 3;
using T                = double;
const char* TestName   = "UniformField";
...
int main(int argc, char* argv[]) {
    ippl::initialize(argc, argv);
    {
        ...
        UniformFieldManager<T, Dim> manager(totalP, nt, nr, lbt, solver, step_method,
