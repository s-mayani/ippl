...
#ifndef IPPL_LAGRANGESPACE_NONUNIFORM_H
#define IPPL_LAGRANGESPACE_NONUNIFORM_H
...
namespace ippl {
    ...
    class LagrangeSpace_nonuniform
        : public FiniteElementSpace_nonuniform<T, Dim, getLagrangeNumElementDOFs(Dim, Order), ElementType,
    ...
    public:
        ...
        static constexpr unsigned dim = FiniteElementSpace_nonuniform<T, Dim, numElementDOFs, ElementType,
        ...
        typedef typename FiniteElementSpace_nonuniform<T, Dim, numElementDOFs, ElementType, QuadratureType,
         ...
         */
        LagrangeSpace_nonuniform(Cartesian<T, Dim>& mesh, ElementType& ref_element,
         ...
         * @param layout Reference to the field layout
         */
        void initialize(Cartesian<T, Dim>& mesh, Layout_t& layout);
...
#include "FEM/LagrangeSpace_nonuniform.hpp"
