...
namespace ippl {
    ...
    LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::LagrangeSpace_nonuniform(
        Cartesian<T, Dim>& mesh, ElementType& ref_element, const QuadratureType& quadrature,
        Layout_t& layout)
        : FiniteElementSpace_nonuniform<T, Dim, getLagrangeNumElementDOFs(Dim, Order), ElementType,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    void LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::initialize(
        Cartesian<T, Dim>& mesh, Layout_t& layout)
    {
        FiniteElementSpace_nonuniform<T, Dim, getLagrangeNumElementDOFs(Dim, Order), ElementType,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    void LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION size_t LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION
    size_t LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::getLocalDOFIndex
    (const size_t& elementIndex, const size_t& globalDOFIndex) const {
        ...
        const Vector<size_t, numElementDOFs> global_dofs =
            this->LagrangeSpace_nonuniform::getGlobalDOFIndices(elementIndex);
    ...
    LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS,
                  FieldRHS>::getGlobalDOFIndex(const size_t& elementIndex,
                                               const size_t& localDOFIndex) const {
        const auto global_dofs = this->LagrangeSpace_nonuniform::getGlobalDOFIndices(elementIndex);
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION Vector<size_t, LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION T
    LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::
        evaluateRefElementShapeFunction(
            const size_t& localDOF,
            const LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION typename LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS,
                                           FieldRHS>::point_t
    LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    template <typename F>
    FieldLHS LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS,
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    template <typename F>
    T LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::computeErrorL2(
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    T LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::computeAvg(
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    typename LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::
    DeviceStruct
    LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType, FieldLHS, FieldRHS>::
    ...
    template <typename T, unsigned Dim, unsigned Order, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION typename LagrangeSpace_nonuniform<T, Dim, Order, ElementType, QuadratureType,
