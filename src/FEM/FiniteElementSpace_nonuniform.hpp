...
namespace ippl {
    ...
    FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType, FieldLHS,
                       FieldRHS>::FiniteElementSpace_nonuniform(Cartesian<T, Dim>& mesh,
    ...
    template <typename T, unsigned Dim, unsigned NumElementDOFs, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    void FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType, FieldLHS,
                       FieldRHS>::setMesh(Cartesian<T, Dim>& mesh)
    {
        assert(mesh.Dimension == Dim && "Mesh dimension does not match the dimension of the space");
    ...
    template <typename T, unsigned Dim, unsigned NumElementDOFs, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION size_t FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType,
    ...
    template <typename T, unsigned Dim, unsigned NumElementDOFs, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION typename FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType,
    ...
    template <typename T, unsigned Dim, unsigned NumElementDOFs, typename ElementType,
              typename QuadratureType, typename FieldLHS, typename FieldRHS>
    KOKKOS_FUNCTION size_t
    FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType, FieldLHS, FieldRHS>::
        getMeshVertexIndex(
            const FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType, FieldLHS,
    ...
    FiniteElementSpace_nonuniform<T, Dim, NumElementDOFs, ElementType, QuadratureType, FieldLHS, FieldRHS>::
        ...
        for (size_t i = 0; i < vertex_nd_indices.dim; ++i) {
            ...
            for (size_t d = 0; d < Dim; ++d) {
                ...
                vertex_points[i][d] = getVertexPosition(temp_ndindex[d]);
            }
        }
