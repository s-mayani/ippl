...
#ifndef IPPL_FEMSPACE_NONUNIFORM_H
#define IPPL_FEMSPACE_NONUNIFORM_H
...
namespace ippl {
    ...
    class FiniteElementSpace_nonuniform {
    public:
         ...
         */
        FiniteElementSpace_nonuniform(Cartesian<T, Dim>& mesh, ElementType& ref_element,
                           const QuadratureType& quadrature);

        void setMesh(Cartesian<T, Dim>& mesh);
...
#include "FEM/FiniteElementSpace_nonuniform.hpp"
